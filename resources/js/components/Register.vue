                            ...
                            <div class="card-body">
                                <div>
                                    <div class="card-body">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <input name="personid" v-model="queryString" v-on:keyup="getResults()" v-text="queryString" type="text" class="form-control" placeholder="Contact Person ID">
                                                <div class="options">
                                                    <ul>
    ...
    export default {
        ...
        methods: {
            ...
            getPhoneNo(){
                ...
                if(this.clientNo){
                    axios.get('api/search', {params: {clientNo:this.clientNo}}).then(res =>  {
