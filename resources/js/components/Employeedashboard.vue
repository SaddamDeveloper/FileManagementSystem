            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-2">
                    <div class="card-body pb-0">
                        ...
                        <router-link to="/assignedcase"><p class="text-light">Process Case</p></router-link>
            ...
            <div class="col-sm-6 col-lg-3">
                <div class="card text-white bg-flat-color-2">
                    <div class="card-body pb-0">
                       ...
                       <router-link to="/waitingforapproavalcase"><p class="text-light">Waiting For Approve</p></router-link>
